...
export function DateNavigation({ selectedDate, onDateChange }: DateNavigationProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 z-50 bg-background border rounded-lg shadow-lg p-3">
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="px-3 py-1.5 border rounded-md bg-background text-foreground text-sm font-sans"
            />
